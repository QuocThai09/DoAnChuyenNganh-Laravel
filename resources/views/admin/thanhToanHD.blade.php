    ...
    <div class="container-fluid" id="main-content">
        <div class="row">
            <div class="col-lg-10 ms-auto p-4 overflow-hidden">
                ...
                <form action="{{ route('payHD')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold">Mã hóa đơn</label>
                                <input type="text" name="MAHOADON" class="form-control shadow-none"
                                value="{{$id}}" readonly>
                            </div>
                        </div>
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3" style="display: none" >
                                    <input type="text" name="THANHTIEN" class="form-control shadow-none"
                                    value="{{$data->THANHTIEN}}"> </div>
                                <div>
